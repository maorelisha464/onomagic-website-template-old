  ...
  return (
    <>
      ...
      <Container size={"md"}>
        ...
        <p>
          5. All notices, including counter-notices, must meet the then-current statutory requirements imposed by the DMCA; see <a href="https://www.copyright.gov/">www.copyright.gov</a> for more details.
        </p>
        <p>
          6. DMCA notices and counter-notices regarding our service should be sent to our designated copyright agent at <strong>info@54.172.149.20</strong>
        </p>
      </Container>
      <Footer1></Footer1>
    </>
