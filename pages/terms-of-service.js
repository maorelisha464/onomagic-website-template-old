        ...
        <>
            ...
            <Container size={"md"}>
                ...
                <ul>
                    ...
                    <li>Use of and access to the Services is void where prohibited by law. You represent and warrant that your use of the Site and Services does not violate any applicable law, regulation, or obligation you may have to a third party and you shall comply with applicable laws, regulations, guidelines, and these Terms throughout your use of the Site and Services.</li>
                    <li>The Services are intended to be used by individuals for whom no parental consent is needed for the use of the Services and/or for the collection of Personal Data in the applicable jurisdiction. If parental consent is required for use of the Services and/or collection of your data, you are prohibited from using the Site and/or Services. The relevant age varies per jurisdiction and is usually between 13-16 years.</li>
                </ul>
                <ol start="2">
                    <li><strong>Content</strong></li>
                </ol>
                <ul>
                    <li>Certain types of content may be made available on the Site. “<strong>Content</strong>” as used in these Terms means, collectively, all content on or made available on the Site, including any images, photos, pictures, videos, or articles, and any modifications or derivatives of the foregoing.</li>
                    <li>COMPANY DOES NOT ENDORSE ANY CONTENT OR ANY OPINION, RECOMMENDATION, OR ADVICE EXPRESSED IN ANY CONTENT AND EXPRESSLY DISCLAIMS ANY AND ALL LIABILITY IN CONNECTION WITH THE CONTENT. COMPANY DISCLAIMS ALL LIABILITY, REGARDLESS OF THE FORM OF ACTION, FOR THE ACTS OR OMISSIONS OF ANY AND ALL USERS (INCLUDING UNAUTHORIZED USERS) THAT ARE NOT SOLELY DUE TO COMPANY’S GROSS NEGLIGENCE OR WILLFUL MISCONDUCT, WHETHER SUCH ACTS OR OMISSIONS OCCUR DURING THE USE OF THE SERVICES OR OTHERWISE.</li>
                </ul>
                <ol start="3">
                    <li><strong>Use&nbsp;</strong>You may not do or attempt to do or facilitate a third party in doing any of the following: (1) decipher, decompile, disassemble, or reverse-engineer any of the software and/or code, if and as applicable, used to provide the Site or Services without our prior written authorization, including framing or mirroring any part of the Site or Services; (2) circumvent, disable, or otherwise interfere with security-related features of the Services or features that prevent or restrict use or copying of any Content; (3) use the Site, Services, or Content in connection with any commercial endeavors in any manner, except as specifically set forth in these Terms; (4) use any robot, spider, site search or retrieval application, or any other manual or automatic device or process to retrieve, index, data-mine, or in any way reproduce or circumvent the navigational structure or presentation of the Site or Services; and/or (5) use the Site, Services, or content thereon in any manner not permitted by these Terms or applicable law.</li>
                    <li><strong>Intellectual Property.&nbsp;</strong>Company or its licensors, as the case may be, have all right, title and interest in the Site, Services, and any Content thereon, including its overall appearance, text, graphics, graphics design, videos, demos, interfaces, and underlying source files, and all worldwide intellectual property rights, the trademarks, service marks, and logos contained therein, whether registered or unregistered. Except as expressly permitted herein, you may not copy, further develop, reproduce, republish, modify, alter download, post, broadcast, transmit or otherwise use the content of the Services for any purpose. You will not remove, alter, or conceal any copyright, trademark, service mark or other proprietary rights notices incorporated in the Services, if any. All trademarks are trademarks or registered trademarks of their respective owners. Nothing in these&nbsp;Terms should be construed as granting you any right to use any trademark, service mark, logo, or trade name of Company or any third party. If you provide Company with any feedback regarding any content on the Services, Company may use all such feedback without restriction and shall not be subject to any non-disclosure or non-use obligations in respect of such feedback.</li>
                    <li><strong>Disclaimers&nbsp;and Disclaimer of Warranty</strong></li>
                </ol>
                <ul>
